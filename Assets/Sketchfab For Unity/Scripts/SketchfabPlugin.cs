...
namespace Sketchfab
{
    public class SketchfabPlugin : MonoBehaviour
    {
        ...
        // Plugin elements
        private static SketchfabUI _ui;
        private static SketchfabLogger _logger;
        private static SketchfabAPI _api;
        ...
        {
            var request = new SketchfabRequest(Urls.bannerUrl);
        ...
        {
            if (_ui == null || _logger == null || _api == null || DEFAULT_AVATAR == null) Initialize();
        }

        public static void checkUpdates()
        {
            var request = new SketchfabRequest(Urls.latestReleaseCheck);
        ...
        {
            var node = Utils.JSONParse(response);
        ...
        public static void displayHeader()
        {
            ...
            if (bannerTexture != null) displayBanner();
        ...
        public static void displayFooter()
        {
            ...
            if (GUILayout.Button("Sketchfab plugin for Unity " + VERSION + " " + versionCaption,
                    _ui.getSketchfabLabel(), GUILayout.Height(20))) Application.OpenURL(Urls.latestRelease);
            GUILayout.FlexibleSpace();
        ...
        public struct Urls
        {
            ...
            public static string reportAnIssue =
                "https://help.sketchfab.com/hc/en-us/requests/new?type=exporters&subject=Unity+Exporter";

            public static string privateInfo =
                "https://help.sketchfab.com/hc/en-us/articles/115000422206-Private-Models";
            ...
            public static string plans =
                "https://sketchfab.com/plans?utm_source=unity-plugin&utm_medium=plugin&utm_campaign=download-api-pro-cta";

            public static string bannerUrl = "https://static.sketchfab.com/plugins/unity/banner.jpg";

            public static string storeUrl =
                "https://sketchfab.com/store?utm_source=unity-plugin&utm_medium=plugin&utm_campaign=store-banner";

            public static string storeUrlButton =
                "https://sketchfab.com/store?utm_source=unity-plugin&utm_medium=plugin&utm_campaign=store-button";

            public static string categories = server + "/v3/categories";
            private static readonly string dummyClientId = "IUO8d5VVOIUCzWQArQ3VuXfbwx5QekZfLeDlpOmW";
