...
namespace Sketchfab
{
    ...
    {
        // UI Elements
        public static Color SKFB_RED = new(0.8f, 0.0f, 0.0f);
        public static Color SKFB_BLUE = new(28 / 255.0f, 170 / 255.0f, 223 / 255.0f);
        public static Color SKFB_BLUE_2 = new(69 / 255.0f, 185 / 255.0f, 223 / 255.0f);
        ...
        private GUIStyle _sketchfabContentLabel;
        public GUIStyle _sketchfabLabel;
        private GUIStyle _sketchfabMiniAuthorname;
        private GUIStyle _sketchfabMiniModelname;

        private GUIStyle _sketchfabModelName;
        private GUIStyle _sketchfabSubContentLabel;
        ...
        private Font OSBold;
        private Font OSLight;
        private Font OSRegular;
        private Font OSSemiBold;

        public Texture SKETCHFAB_ICON;

        private Font TitiliumBlack;
        private Font TitiliumBold;
        private Font TitiliumLight;
        private Font TitiliumRegular;
        private Font TitiliumSemibold;
        private Font TitiliumThin;
        ...
        {
            return "<color=" + ERROR_COLOR + ">" + text + "</color>";
        }
    }
}
#endif