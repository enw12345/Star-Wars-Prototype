...
{
    //Make the pixels move toward the camera ??
            ...
            fixed4 starCol = step(randomCol, float4(_StarFieldDensity, _StarFieldDensity, _StarFieldDensity, _StarFieldDensity)) * _StarFieldBrightness * rand3dTo1dBW(random);
